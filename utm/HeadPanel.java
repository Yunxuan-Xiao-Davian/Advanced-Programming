...
public class HeadPanel extends JPanel {
  ...
  public HeadPanel(Head head) { 
    ...
    try {
      headImage = ImageIO.read(utm.Config.class.getResource("tm-head.png"));
  ...
  public void moveRight() {
    ...
    if(head.getCurrentCell() < utm.Config.MAX_CELLS-1) {
      head.moveRight();
      repaint(); 
    }
  ...
  public void paintComponent(Graphics g) {
    ...
    int headPos = head.getCurrentCell() * utm.Config.CELL_WIDTH;
    ...
    g.fillRect(0, 0, utm.Config.HEAD_X_END, utm.Config.HEAD_HEIGHT);
    ...
    g.drawString(
      ...
      headPos + (utm.Config.HEAD_WIDTH - (int)Math.ceil(stateBounds.getWidth()))/2,
      utm.Config.HEAD_HEIGHT/2 + 20
    );
  }
